...
public:
    ...
    bool SelectTokensMinConf(const CAmount& nTargetValue, const int nConfMine,
    ...
    bool LoadKeyMetadata(const CTxDestination& keyID, const CKeyMetadata &meta);
    ...
    CAmount GetBalance(bool fExcludeNotExpiredTimelock=false) const;
    CAmount GetUnconfirmedBalance() const;
    CAmount GetImmatureBalance() const;
    CAmount GetWatchOnlyBalance() const;
    CAmount GetUnconfirmedWatchOnlyBalance() const;
    CAmount GetImmatureWatchOnlyBalance() const;
    CAmount GetLegacyBalance(const isminefilter& filter, int minDepth, const std::string* account, bool fExcludeNotExpiredTimelock = false) const;
     ...
     */
    bool FundTransaction(CTransaction& tx, CAmount& nFeeRet, int& nChangePosInOut, std::string& strFailReason, bool lockUnspents, const std::set<int>& setSubtractFeeFromOutputs, CCoinControl);
    ...
    bool CreateTransactionWithTokens(
        ...
        const ETokenType& tokenType, bool sign = true);
    ...
    bool CreateTransactionWithReissueToken(
        ...
        CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosInOut,
        std::string& strFailReason, const CCoinControl& coinControl,
        const CReissueToken& reissueToken, const CTxDestination destination, bool sign = true);
    ...
    bool CreateTransaction(CScript scriptPubKey, ::int64_t nValue,
            ...
            const CScript *fromScriptPubKey = NULL,
            bool useExpiredTimelockUTXO = false, bool sign = true);
    ...
    bool CreateTransactionAll(
        ...
        const CReissueToken& reissueToken, const ETokenType& tokenType, bool sign = true);
     ...
     */
    static CAmount GetMinimumFee(unsigned int nTxBytes, const CCoinControl& coin_control);
    /**
