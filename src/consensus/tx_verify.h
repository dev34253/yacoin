...
#ifndef YACOIN_CONSENSUS_TX_VERIFY_H
#define YACOIN_CONSENSUS_TX_VERIFY_H
 ...
 */
bool CheckTxInputs(const CTransaction& tx, CValidationState& state, const CCoinsViewCache& inputs, int nSpendHeight, const CBlockIndex* pindexBlock);

/** YAC_TOKEN START */
bool CheckTxTokens(
    const CTransaction& tx, CValidationState& state,
    const CCoinsViewCache& inputs, CTokensCache* tokenCache, bool fCheckMempool,
...
#endif // YACOIN_CONSENSUS_TX_VERIFY_H
